...
rm -rf dist
mkdir -p dist/portal dist/anticipos dist/cxc dist/liquidaciones dist/nomina dist/incidentes dist/historial dist/usuarios
...
echo "build.sh: dist/ generado con 8 sites."
